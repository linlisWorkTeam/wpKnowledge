...
const TRANSITIONS: Record<RunState, ReadonlySet<RunState>> = {
  ...
  GENERATING: new Set(['EVALUATING', 'LOW_CONFIDENCE', 'CANCELLED', 'FAILED']),
  EVALUATING: new Set(['REVIEWING', 'PUBLISHING', 'CANCELLED', 'FAILED']),
  REVIEWING: new Set(['ITERATING', 'ROLLING_BACK', 'LOW_CONFIDENCE', 'FAILED', 'CANCELLED']),
