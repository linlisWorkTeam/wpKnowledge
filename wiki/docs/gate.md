...
| 5 | **知识飞轮与首次生成 agent 的迭代机制**（两者如何协作迭代知识） | 待定 |
...
- 依据：[self-debugging.md](../research/feedback-loop/self-debugging.md)（执行反馈最有效）、gate.md §3.5 多信号组合（测试本就是建议信号之一）
- 证据参考：[test-gen-from-docs.md](../research/evaluation/test-gen-from-docs.md)（从文档生成测试）
