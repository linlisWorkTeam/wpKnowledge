...
- [code-qa-bench.md](code-qa-bench.md) — 代码推理 vs 文档记忆分离（评测防污染的另一角度）
- docs/gate.md — 门禁评测设计（防作弊、多信号组合）
- [cannbot-knowledge.md](cannbot-knowledge.md) — knowledge-lint 治理流程
- [test-gen-from-docs.md](test-gen-from-docs.md) — 用测试验证文档质量（下游任务间接验证）
