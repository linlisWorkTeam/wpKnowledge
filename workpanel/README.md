...
- `docs/2026-08-22-endless-wpknowledge-runner-analysis.md`：endlessWpKnowledgeRunner 飞轮实现、验证结果与风险分析。
- `docs/2026-08-22-workpanel-connecter-implementation-analysis.md`：WorkPanelConnecter 当前源码实现、数据流、联邦与验证边界分析。
- `docs/YYYY-MM-DD-<topic>.md`：按日期保存的专题调研报告。
- `notes/`：调研证据、过程记录、未确认事项和后续问题。

报告应注明研究日期、目标仓库 commit、证据来源和证据边界。新增调研优先保留日期快照；综合结论有实质变化时，再同步更新长期报告。
