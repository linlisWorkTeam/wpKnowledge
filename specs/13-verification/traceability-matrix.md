...
| KF-SYS-005 | AC-EVAL-002 | Implemented | packages/adapters/project-eval + evidence-bound deterministic gate | tests/acceptance/real-source-flow.test.ts + workpanel/notes/2026-09-01-ohmyworkpanel-real-source-e2e.md |
...
| KF-SYS-017 | AC-E2E-001 | Implemented | packages/application/project-flow + project EvalRunner | tests/acceptance/real-source-flow.test.ts + workpanel/notes/2026-09-01-ohmyworkpanel-real-source-e2e.md |
...
| NFR-008 | AC-EVAL-003 | Implemented | deterministic gate + immutable process evidence + toolchain fingerprint | tests/acceptance/real-source-flow.test.ts + workpanel/notes/2026-09-01-ohmyworkpanel-real-source-e2e.md |
...
| NFR-011 | AC-E2E-001 | Implemented | project acceptance report + CAS evidence | tests/acceptance/real-source-flow.test.ts + workpanel/notes/2026-09-01-ohmyworkpanel-real-source-e2e.md |
