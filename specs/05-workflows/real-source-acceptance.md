...
验收报告至少包含：runId、两版 knowledge version、Correction、参考/失败/最终门禁结果、工具链版本、每条 argv、工作区摘要、CAS ArtifactRef、GateDecision、publication receipt、事件序列、执行日期与证据边界。报告保存到 `workpanel/notes/`，自动化测试使用最小仓库 fixture 验证同一编排语义。
