...
> 图文白话版 · 2026-08-20  
> 技术原文：[DSH反汇编调查](./DSH反汇编调查.md)
> 机制借鉴版：[dsh-analysis-report.md](./DSH可借鉴性分析报告.md)
...
![四层楼示意：模型 API → Harness 内核 → 编码 CLI → 多 Agent 平台](../资源/dsh-layers-plain.png)
...
![dsh 核心能力：会话、提示词、工具、模型、审批、压缩](../资源/dsh-seams-plain.png)
...
| 文件 | 内容 |
|---|---|
| [assets/dsh-layers-plain.png](../资源/dsh-layers-plain.png) | 四层楼示意 |
| [assets/dsh-seams-plain.png](../资源/dsh-seams-plain.png) | 能力雷达 / 接缝示意 |
