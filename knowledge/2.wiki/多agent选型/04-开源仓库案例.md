...
gpt-engineer, CrewAI seq,    LangGraph,               AutoGen 0.4,             MetaGPT 消息池,
ChatDev 阶段间, DocAgent,    LangGraph supervisor     OpenHands EventStream    ChatDev 阶段内
RepoAgent, aider,            /swarm, AutoGen 0.2
Anthropic orchestrator       GroupChat
```
