...
1. **门禁评测要防"文档污染"**：如果我们用"文档质量"作为门禁信号，评测集必须像 Code2Doc 一样做质量过滤，否则噪声文档会污染门禁判断（对应 设计/门禁与评测机制.md 的防作弊原则）
...
- 人工质量标注的成本：Code2Doc 靠规则+抽检，我们的大规模知识库要设计自动化质量信号（多信号组合，见 设计/门禁与评测机制.md）

## 关联

- [代码问答基准与文档记忆区分.md](代码问答基准与文档记忆区分.md) — 代码推理 vs 文档记忆分离（评测防污染的另一角度）
- 设计/门禁与评测机制.md — 门禁评测设计（防作弊、多信号组合）
- [Cannbot知识库插件.md](Cannbot知识库插件.md) — knowledge-lint 治理流程
