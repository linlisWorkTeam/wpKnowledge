...
v0.2.0 已在本机完成这条拓扑的 P0-P3 实现，并通过 48 项发布门禁、真实 WorkPanel canary 消息路由，以及额外 10 分钟和 8 分钟三进程重复 soak。它仍是 release candidate：真实两站点 + 独立 Host 的 TLS/mTLS、72 小时 soak 和外部告警集成尚未验收。
